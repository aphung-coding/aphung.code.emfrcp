...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>family</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class FamilyExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.family"));
				Family root = FamilyFactory.eINSTANCE.createFamily();
